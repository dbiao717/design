"undefined" == typeof jwplayer && (jwplayer = function(f) {
        ...
        b.getAbsolutePath = function(h, a) {
                ...
                if (b.exists(h)) {
                        ...
                        for (var g = [], m = 0; m < e.length; m++)
                                e[m] && (b.exists(e[m]) && "." != e[m]) && (".." == e[m] ? g.pop() : g.push(e[m]));
                        return d + c + "/" + g.join("/")
                }
        };
        b.extend = function() {
        ...
        b.log = function(a, b) { /*"undefined"!=typeof console&&"undefined"!=typeof console.log&&(b?console.log(a,b):console.log(a))*/
        };
                ...
                switch (f.utils.typeOf(a)) {
                        case "array":
                                for (var e = 0; e < a.length; e++)
                                        a[e] = f.utils.deepReplaceKeyName(a[e], d, c);
                                break;
                        case "object":
                                b.foreach(a, function(b, g) {
                                        ...
                                        if (d instanceof Array && c instanceof Array) {
                                                ...
                                                e = [d];
                                        for (var n = b, k = 0; k < e.length; k++)
                                                n = n.replace(RegExp(d[k], 
                                                "g"), c[k]);
        ...
        f.scriptloader = function(e) {
                ...
                this.load = function() {
                        ...
                        if (h && (h.getStatus() == 
                        a.NEW || h.getStatus() == a.LOADING))
                                h.addEventListener(n.ERROR, c), h.addEventListener(n.COMPLETE, b);
        ...
        a.encrypt = function(c, b) {
                ...
                for (var n = a.strToLongs(e.encode(b).slice(0, 16)), h = d.length, f = d[h - 1], p = d[0], q, j = Math.floor(6 + 52 / h), g = 0; 0 < j--; ) {
                        ...
                        q = g >>> 2 & 3;
                        for (var m = 0; m < h; m++)
                                p = d[(m + 1) % h], f = (f >>> 5 ^ p << 2) + (p >>> 3 ^ f << 4) ^ (g ^ p) + (n[m & 3 ^ q] ^ f), f = d[m] += f
                }
                d = a.longsToStr(d);
                return k.encode(d)
        };
        ...
        b) {
                ...
                for (var d = a.strToLongs(k.decode(c)), n = a.strToLongs(e.encode(b).slice(0, 16)), h = d.length, f = d[h - 1], p = d[0], q, j = 2654435769 * Math.floor(6 + 52 / h); 0 != j; ) {
                        q = j >>> 2 & 3;
                        for (var g = h - 1; 0 <= g; g--)
                                f = d[0 < g ? g - 1 : h - 1], f = (f >>> 5 ^ p << 2) + (p >>> 3 ^ f << 4) ^ (j ^ p) + (n[g & 3 ^ q] ^ f), p = d[g] -= f;
                        j -= 2654435769
                }
                d = a.longsToStr(d);
                d = d.replace(/\0+$/, "");
        ...
        a.strToLongs = function(a) {
                for (var b = Array(Math.ceil(a.length / 4)), d = 0; d < b.length; d++)
                        b[d] = a.charCodeAt(4 * d) + (a.charCodeAt(4 * d + 1) << 8) + (a.charCodeAt(4 * d + 
                        2) << 16) + (a.charCodeAt(4 * d + 3) << 24);
                return b
        };
        a.longsToStr = function(a) {
                for (var b = Array(a.length), d = 0; d < a.length; d++)
                        b[d] = String.fromCharCode(a[d] & 255, a[d] >>> 8 & 255, a[d] >>> 16 & 255, a[d] >>> 24 & 255);
                return b.join("")
        };
        var k = {code: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d",encode: function(a, b) {
                        ...
                        for (j = 0; j < g.length; j += 3)
                                d = g.charCodeAt(j), n = g.charCodeAt(j + 
                        ...
                        for (var m = 0; m < j.length; m += 4)
                                d = g.indexOf(j.charAt(m)), f = g.indexOf(j.charAt(m + 1)), r = g.indexOf(j.charAt(m + 2)), p = g.indexOf(j.charAt(m + 3)), h = d << 18 | f << 12 | r << 6 | p, d = h >>> 16 & 255, f = h >>> 8 & 255, h &= 255, q[m / 4] = String.fromCharCode(d, f, 
        ...
        f.plugin = function(e) {
                ...
                this.load = function() {
                        if (n == a.loaderstatus.NEW)
                                if (0 < e.lastIndexOf(".swf"))
                                        h = e, n = a.loaderstatus.COMPLETE, j.sendEvent(k.COMPLETE);
                                else if (a.getPluginPathType(e) == a.pluginPathType.CDN)
                                        n = a.loaderstatus.COMPLETE, 
                                        j.sendEvent(k.COMPLETE);
                                else {
                ...
                this.getPluginmode = function() {
                        if ("undefined" != typeof h && "undefined" != typeof r)
...
function(f) {
                ...
                function n() {
                        ...
                        if (!r && !p) {
                                ...
                                a.foreach(j, function(c) {
                                        ...
                                        if (g == a.loaderstatus.LOADING || g == a.loaderstatus.NEW)
                                                b++;
                                        else if (c && (!h || parseFloat(h) > parseFloat(f.version)))
                                                p = !0, q = "Incompatible player version", d()
                                });
                                0 == b && d()
                        }
                }
        ...
        f.playlist = function(a) {
                ...
                if ("array" == f.utils.typeOf(a))
                        for (var e = 0; e < a.length; e++)
                                k.push(new f.playlist.item(a[e]));
                else
                        k.push(new f.playlist.item(a));
                return k
        }
}(jwplayer), function(f) {
        var a = f.item = function(k) {
                ...
                if (c.captions && !e.exists(k.tracks)) {
                        for (k = 0; k < c.captions.length; k++)
                                c.tracks.push(c.captions[k]);
                        delete c.captions
                }
                for (b = 0; b < c.tracks.length; b++)
                        c.tracks[b] = new f.track(c.tracks[b]);
                return c
        };
                        ...
                        0 == m.playlist[0].sources.length))
                                ...
                                for (var f = 0; f < m.modes.length; f++)
                                        if (m.modes[f].type && d[m.modes[f].type]) {
                                                ...
                                                if (D.supportsConfig())
                                                        return D.addEventListener(k.ERROR, r), D.embed(), h(n, j.events), n
                                        }
                                if (m.fallback) {
                                        ...
                                        t = "No suitable players found and fallback disabled", 
        ...
        function a(a) {
                if (a.playlist)
                        for (var d = 0; d < a.playlist.length; d++)
                                a.playlist[d] = new c(a.playlist[d]);
                else {
                        var f = {};
        ...
        f.embed.download = function(e, c, b) {
                function d(b, c) {
                        for (var d = k.querySelectorAll(b), e = 0; e < d.length; e++)
                                a.foreach(c, 
                                function(a, b) {
                                        d[e].style[a] = b
                                })
        ...
        (f.embed.flash = function(c, b, d, n, h) {
                ...
                this.embed = function() {
                        d.id = h.id;
                        if (10 > g)
                                return j.sendEvent(k.ERROR, {message: "Flash version must be 10.0 or greater"}), 
                                !1;
                        var f, l, t = h.config.listbar, u = a.extend({}, d);
                        if (c.id + "_wrapper" == c.parentNode.id)
                                f = document.getElementById(c.id + "_wrapper");
                        else {
                                        ...
                                        try {
                                                ...
                                                for (var c = 0; c < b.length; c++) {
                                                        ...
                                                        if (e = b[c].file) {
                                                                ...
                                                                if (a.isYouTube(f) || a.isRtmp(f, h) || "hls" == h)
                                                                        e = !0;
                                                                else {
        ...
        f.embed.html5 = function(c, b, d, n, h) {
                ...
                q.embed = function() {
                        if (f.html5) {
                                ...
                                g = new a.scriptloader(b.src), g.addEventListener(e.ERROR, p), g.addEventListener(e.COMPLETE, q.embed), g.load()
                };
                        ...
                        if (f.vid.canPlayType)
                                try {
                                        ...
                                        for (var b = d.playlist[0].sources, c = 0; c < b.length; c++) {
                                                ...
                                                if (null !== navigator.userAgent.match(/BlackBerry/i) || a.isAndroid() && ("m3u" == a.extension(h) || "m3u8" == a.extension(h)) || a.isRtmp(h, j))
                                                        e = !1;
                                                else {
                                                        var n = k[j ? j : a.extension(h)], p;
                                                        if (!n || n.flash && !n.html5)
                                                                p = !1;
                                                        else {
        ...
        c = e.state, b = document, d = f.api = function(a) {
                                ...
                                if (c == a) {
                                        ...
                                        if (d)
                                                for (var e = 0; e < d.length; e++)
                                                        "function" == typeof d[e] && d[e].call(this, {oldstate: b,newstate: c})
                                }
                        }));
                        l[a].push(b);
                        return g
                ...
                function(a) {
                        ...
                        for (g.dispatchEvent(e.API_READY); 0 < w.length; )
                                j.apply(this, w.shift())
                };
        ...
        d.destroyPlayer = function(c) {
                for (var d = -1, e, f = 0; f < a.length; f++)
                        a[f].id == c && (d = f, e = a[f]);
        ...
        f.api.instream = function(c, b, d, f) {
                ...
                this.dispatchEvent = function(a, b) {
                        if (j[a])
                                for (var c = k.translateEventResponse(a, b[1]), d = 0; d < j[a].length; d++)
                                        "function" == typeof j[a][d] && j[a][d].call(this, c)
                };
